...
Revision ID: 3e0d2c5e17af
Revises: 
Create Date: 2025-04-04 17:34:01.984013
...
def upgrade() -> None:
    ...
    sa.Column('pe_ratio', sa.Float(), nullable=True, comment='PER'),
    sa.Column('dividend_yield', sa.Float(), nullable=True, comment='배당수익률'),
    sa.Column('sector', sa.String(length=50), nullable=True, comment='섹터'),
    sa.Column('industry', sa.String(length=50), nullable=True, comment='산업'),
    sa.Column('description', sa.String(length=500), nullable=True, comment='증권 설명'),
    sa.Column('last_updated', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='마지막 업데이트 시간'),
    ...
    sa.Column('portfolio_type', sa.Enum('AGGRESSIVE', 'BALANCED', 'CONSERVATIVE', name='portfoliotype'), nullable=True, comment='선호 포트폴리오 유형'),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True, comment='생성 일시'),
    ...
    sa.Column('portfolio_type', sa.Enum('BALANCED', 'AGGRESSIVE', 'CONSERVATIVE', name='portfoliotype'), nullable=False, comment='포트폴리오 유형'),
    ...
    sa.Column('amount', sa.Float(), nullable=False, comment='금액 (원화)'),
    ...
    sa.Column('user_id', sa.String(length=36), nullable=True, comment='사용자 ID'),
    ...
    sa.Column('price_at_time', sa.Float(), nullable=False, comment='추천 시점의 주가'),
    sa.Column('total_investment', sa.Float(), nullable=False, comment='총 투자금액'),
    sa.Column('market_cap', sa.Float(), nullable=False, comment='시가총액'),
    sa.Column('change_rate', sa.Float(), nullable=False, comment='등락률'),
    sa.Column('volume', sa.Integer(), nullable=False, comment='거래량'),
    sa.Column('id', sa.String(length=36), nullable=False, comment='UUID 형식의 고유 식별자'),
